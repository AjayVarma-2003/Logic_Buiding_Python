...
def Addition(iNo1 , iNo2):      
    iSum = int(iNo1) + int(iNo2)        #Variable to store addition result
    return iSum
...
iValue1 = input("Enter first value : ")     #Variable to store 1st input

iValue2 = input("Enter second value : ")    #Variable to store 2nd input

iAns = Addition(iValue1 , iValue2)          #Variable to store result
